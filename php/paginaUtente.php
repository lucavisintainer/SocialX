    ...
    <div class="container">
        <div class="left-section">
            ...
            if (followButton() != 'AMICI') {
                if(visibilitaAccount($idProfilo)=='A'){
            ?> <br><br><br><br><br><br><br>
                <div class="profilo-privato">
                    <img src="../img/icone/profiloPrivato.png" alt="Profilo privato">
                    Profilo privato
                </div>
                <?php
                }else{
                    if (trovaIDpost($idProfilo) == false) { ?> <br><br><br><br><br><br><br> <?php
                        echo "Non sono presenti post";
                    } else {
                        echo mostraPost();
                    }
                }
