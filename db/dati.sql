...
/* Post */
INSERT INTO post (data, descrizione, fkProfilo, tipoPost, prezzo) VALUES
('2022-01-05 10:00:00', 'Oggi ho visitato un bellissimo museo!', 1, 'N', 0),
('2022-01-06 11:00:00', 'Sono appena tornata da una vacanza favolosa!', 2, 'N', 0),
('2022-01-07 12:00:00', 'Buongiorno a tutti, oggi è una splendida giornata di sole!', 3, 'N', 0),
('2022-01-08 13:00:00', 'Oggi ho salvato una vita al pronto soccorso!', 4, 'N', 0),
('2022-01-09 14:00:00', 'Prova il nostro nuovo prodotto, è fantastico!', 1, 'P', 50),
('2022-01-10 15:00:00', 'Vieni a provare il nostro ristorante, ti aspettiamo!', 2, 'P', 30),
('2022-01-11 16:00:00', 'Il nostro nuovo libro è finalmente disponibile!', 3, 'P', 20),
('2022-01-12 17:00:00', 'Vieni a provare la nostra nuova ricetta, è deliziosa!', 4, 'P', 40),
('2022-03-17 15:00:00', 'Oggi ho corso la mia prima maratona!', 1, 'N', 0),
('2022-03-16 14:00:00', 'Ho fatto un bellissimo viaggio in Giappone, consiglio a tutti di andarci almeno una volta nella vita!', 2, 'N', 0),
('2022-03-15 13:00:00', 'Oggi ho cucinato una lasagna perfetta!', 2, 'N', 0),
('2022-03-14 12:00:00', 'Questo è il mio primo post su questa piattaforma!', 3, 'N', 0),
('2022-03-13 11:00:00', 'Ieri ho visto il nuovo film di Tarantino, è spettacolare!', 4, 'N', 0),
('2022-03-12 10:00:00', 'Oggi ho suonato il mio nuovo violino, suona alla perfezione!', 4, 'N', 0),
('2022-03-11 09:00:00', 'Stamattina ho fatto una bella passeggiata in montagna', 5, 'N', 0),
('2022-01-01 10:30:00', 'Nuovo post di Mario!', 1, 'F', NULL),
('2022-01-02 11:30:00', 'Viaggio fantastico ad Amsterdam!', 2, 'F', NULL),
('2022-01-03 12:30:00', 'Novità dal mondo della medicina', 3, 'A', NULL),
('2022-01-04 13:30:00', 'Ricetta del mio piatto preferito', 4, 'F', NULL),
('2022-01-05 14:30:00', 'Recensione del nuovo smartphone', 1, 'A', NULL),
('2022-01-06 15:30:00', 'Foto di una magnifica vista', 2, 'F', NULL),
('2022-01-07 16:30:00', 'Nuova scoperta scientifica', 3, 'A', NULL),
('2022-01-08 17:30:00', 'Tutorial per preparare una torta', 4, 'F', NULL),
('2022-03-17 10:45:00', 'Le ultime novità dal mondo della tecnologia', 5, 'A', NULL),
('2022-03-17 11:45:00', 'Ricetta per una cena romantica', 6, 'F', NULL),
('2022-03-17 12:45:00', 'Foto del mio ultimo trekking', 7, 'F', NULL),
('2022-03-17 13:45:00', 'Recensione del nuovo film in uscita', 8, 'A', NULL),
('2022-03-17 14:45:00', 'Foto della mia ultima creazione musicale', 9, 'F', NULL),
('2022-03-17 15:45:00', 'Articolo sulle ultime tendenze nel mondo dello sport', 10, 'A', NULL),
('2022-03-17 16:45:00', 'Nuova invenzione', 11, 'A', NULL),
('2022-03-17 17:45:00', 'Ricetta per una torta a forma di cuore', 6, 'F', NULL);
